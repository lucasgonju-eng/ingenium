...
$candidateSubject = "InGenium | Cadastro não elegível";
...
<div style='font-family:Arial,sans-serif;background:#0a1b33;color:#ffffff;padding:24px;'>
  <div style='max-width:620px;margin:0 auto;background:#10274a;border:1px solid #1f3d6d;border-radius:12px;padding:20px;'>
    ...
    <p style='margin:0 0 12px 0;'>Você não é aluno Einstein 2026.</p>
    <p style='margin:0 0 12px 0;'>Deseja entrar em contato? O e-mail é <strong>contato@ingenium.einsteinhub.co</strong>.</p>
