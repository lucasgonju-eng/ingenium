...
$subject = trim((string) ($payload["subject"] ?? "InGenium Einstein | A contagem de XP começou!"));
$headline = trim((string) ($payload["headline"] ?? "A contagem de XP começou oficialmente!"));
$opening = trim((string) ($payload["opening"] ?? "Olá, lobo(a) olímpico(a)!"));
$bodyA = trim((string) ($payload["bodyA"] ?? "A partir de agora, a contagem de XP do InGenium Einstein já está valendo para premiação."));
...
foreach ($recipients as $recipient) {
  ...
  <div style='font-family:Arial,sans-serif;background:#0a1b33;color:#ffffff;padding:24px;'>
    <div style='max-width:620px;margin:0 auto;background:#10274a;border:1px solid #1f3d6d;border-radius:12px;padding:20px;'>
      ...
      <p style='margin:0 0 10px 0;'>$opening</p>
      <p style='margin:0 0 12px 0;'>$safeName, <strong>$headline</strong></p>
