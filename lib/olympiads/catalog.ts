...
const HIDDEN_OLYMPIAD_TITLE_SNIPPETS = ["olimpiada de fisica aplicada", "olimpiada de quimica", "olimpiada nacional de matematica"];
...
export const olympiadCatalog: OlympiadCatalogItem[] = [
  ...
  {
    slug: "obp",
    name: "OP — Olimpíada de Português",
    organizer: "Olimpíada de Português (OP)",
    category: "Linguagens / Língua Portuguesa",
    mentorTeacher: "Professora Thammy",
    coMentorTeacher: "Professora a definir (Fundamental I)",
    officialUrl: "https://olimpiadadeportugues.org/",
    siteCtaLabel: "Portal oficial",
    regulationUrl: "https://olimpiadadeportugues.org/",
    showRegulationCta: true,
    regulationCtaLabel: "Inscrição / regulamento",
    contactEmail: "contato@olimpiadadeportugues.org",
    contactCtaLabel: "Contato",
    visualSealLabel: "OP OFICIAL",
    headline: "Domine leitura, escrita e argumentação para brilhar nas provas e na vida.",
    shortDescription:
      "Competição nacional de Língua Portuguesa para Anos Finais e Ensino Médio, com foco em interpretação, repertório, escrita e excelência acadêmica.",
    longDescription:
      "A OP — Olimpíada de Português é uma competição nacional para estudantes do Ensino Fundamental II e do Ensino Médio, com trilha de desafios que fortalece leitura, interpretação, produção textual e argumentação. É uma excelente oportunidade para elevar performance em provas, redação e comunicação, representando o Einstein em uma olimpíada de alta visibilidade acadêmica.",
    format: {
      modalidade: "Online (conforme a edição vigente no portal oficial)",
      estrutura: "Fases e modalidades definidas no regulamento anual da OP",
      publico: "Anos Finais (Fundamental II) e Ensino Médio",
      participation: "Individual (conforme regras da edição vigente)",
      observacao:
        "Inscrições OP 2026 abertas no portal oficial. Datas e regras podem ser atualizadas pela organização durante o ciclo.",
    },
    schedule: {
      timezone: "America/Sao_Paulo",
      displayTimezoneLabel: "horário de Brasília",
